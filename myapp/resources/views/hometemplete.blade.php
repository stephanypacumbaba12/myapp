...
@section('header')
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    @section('home')
    <section class="back" style="background-color: rgba(255, 255, 255, 0.8); background-image: url('images/Shoes.png'); background-size: cover; background-position: center; height: 100vh; width: 100%; display: flex; justify-content: center; align-items: center;">
